/* src/config/stone-config.h.  Generated from stone-config.h.in by configure.  */
/* src/config/stone-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Stone Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Stone Core"
...
#define PACKAGE_BUGREPORT "https://github.com/stone/stone/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Stone Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Stone Core 2.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "stonecore"
